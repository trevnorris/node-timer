/* Description:
 *
 * Writes data from server to client. Both the client and server use the old
 * streams.
 *
 * Usage:
 *
 ...
 * Example:
 *
 *   node tcp_net_s2c.js --port 3000 --size 0xffffff --iter 5
 */
